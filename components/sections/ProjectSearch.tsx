      ...
      <div className="container-x">
        <div className="max-w-3xl mx-auto reveal">
          ...
          <div className="text-center mb-7">
            ...
            <h3 className="mt-3 text-3xl md:text-4xl font-semibold tracking-tight text-text-1">
              Search anything we've <span className="accent-italic">shipped.</span>
            </h3>
          </div>

          {/* Search bar */}
          <div className="surface flex items-center gap-3 px-6 py-2 rounded-full focus-within:border-accent focus-within:shadow-glow-accent transition-all duration-300">
            ...
            <input
              ...
              className="flex-1 bg-transparent border-none outline-none py-3 text-base text-text-1 placeholder:text-text-3"
              autoComplete="off"
            />
          ...
          <div className="mt-8 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
            {visible.map((p) => (
              <Link
                key={p.id}
                href="/showcase"
                className="group surface p-5 rounded-2xl flex flex-col gap-2 transition-all hover:border-accent/40 hover:bg-surface-2 hover:-translate-y-0.5"
              >
